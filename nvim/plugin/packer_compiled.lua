...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  undotree = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/undotree",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
    url = "https://github.com/airblade/vim-gitgutter"
  },
  ["vim-smoothie"] = {
    loaded = true,
    path = "/Users/chris/.local/share/nvim/site/pack/packer/start/vim-smoothie",
