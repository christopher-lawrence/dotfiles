-- taken from https://github.com/VonHeikemen/lsp-zero.nvim/blob/v4.x/lua/lsp-zero/cmp.lua
local M = {}

---@class cmp-helper.CmpFormatOpts
---@inlinedoc
---
...
function M.action()
	return require("plugins.cmp-helper.cmp-mapping")
end

---@class cmp-helper.CmpExtendOpts
---@inlinedoc
---
...
---@param opts cmp-helper.CmpExtendOpts
