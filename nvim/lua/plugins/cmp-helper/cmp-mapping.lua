-- taken from https://github.com/VonHeikemen/lsp-zero.nvim/blob/v4.x/lua/lsp-zero/cmp-mapping.lua

---@class cmp-helper.cmp_mappings
local M = {}
local s = {}
...
function M.vim_snippet_jump_forward()
	...
	if not vim_snippet_support() then
		local msg = "[chris-cmp] vim.snippet module is not available."
